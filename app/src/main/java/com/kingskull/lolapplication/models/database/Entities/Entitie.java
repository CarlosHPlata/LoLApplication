...
public abstract class Entitie{
    ...
    private long id; // el id de la entidad, si la entidad es nueva y no ha sido insertada a la base de datos, su valor debe ser -1

    public Entitie(){

    }

    protected Entitie(long id, String tableName, String[] columnNames) {
        this.id = id;
