package com.kingskull.lolapplication.summoner.data.views.fragments;
...
import com.kingskull.lolapplication.summoner.data.views.widgets.CircularProgressBar;
...
public class SummonerInfo extends Fragment {
    ...
    private void fillVars(){
        ...
        int rate = utils.calculateWinRate(entry.getWins(), entry.getLosses());
        ...
        ((TextView) fragment.findViewById(R.id.deaths_champion)).setText( utils.getDeaths(stat) );
